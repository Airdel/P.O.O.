========================================================================
    APLICACIÓN DE CONSOLA: Tarea descuento tienda Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Tarea descuento tienda.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación Tarea descuento tienda.


Tarea descuento tienda.vcxproj
...
Tarea descuento tienda.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado Tarea descuento tienda.pch y un archivo de tipos precompilados llamado StdAfx.obj.
