========================================================================
    APLICACIÓN DE CONSOLA: Tarea Numeros romanos Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Tarea Numeros romanos.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación Tarea Numeros romanos.


Tarea Numeros romanos.vcxproj
...
Tarea Numeros romanos.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado Tarea Numeros romanos.pch y un archivo de tipos precompilados llamado StdAfx.obj.
