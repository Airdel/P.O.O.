========================================================================
    APLICACIÓN DE CONSOLA: Calificacion letra a numero 
                           Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Calificacion letra a numero.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación Calificacion letra a numero.


Calificacion letra a numero.vcxproj
...
Calificacion letra a numero.vcxproj.filters
...
Calificacion letra a numero.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado Calificacion letra a numero.pch y un archivo de tipos 
