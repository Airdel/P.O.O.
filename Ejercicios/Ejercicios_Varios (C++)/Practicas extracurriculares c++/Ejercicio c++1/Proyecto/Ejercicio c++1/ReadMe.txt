========================================================================
    APLICACIÓN DE CONSOLA: Ejercicio c++1 
                           Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Ejercicio c++1.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación Ejercicio c++1.


Ejercicio c++1.vcxproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado Ejercicio c++1.pch y un archivo de tipos 
