========================================================================
    APLICACIÓN DE CONSOLA: Calculador Simple 
                           Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Calculador Simple.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación Calculador Simple.


Calculador Simple.vcxproj
...
Calculador Simple.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado Calculador Simple.pch y un archivo de tipos 
