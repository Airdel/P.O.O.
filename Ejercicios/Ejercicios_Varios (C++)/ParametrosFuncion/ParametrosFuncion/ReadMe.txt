========================================================================
    APLICACIÓN DE CONSOLA: ParametrosFuncion 
                           Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación ParametrosFuncion.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación ParametrosFuncion.


ParametrosFuncion.vcxproj
...
ParametrosFuncion.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado ParametrosFuncion.pch y un archivo de tipos 
