========================================================================
    APLICACIÓN DE CONSOLA: Ciclos v2 (version 2015) Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Ciclos v2 (version 2015).

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación Ciclos v2 (version 2015).


Ciclos v2 (version 2015).vcxproj
...
Ciclos v2 (version 2015).vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado Ciclos v2 (version 2015).pch y un archivo de tipos precompilados llamado StdAfx.obj.
