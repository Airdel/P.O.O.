Public Class Form2
    ...
    Private Sub btnVerInventario_Click(ByVal sender As Object, ByVal e As EventArgs)
        Dim Mensaje As String = Nothing
        For x = 0 To 5
            Mensaje += "#id" & a(x).Numero & Space(5) & "Nombre:" & a(x).Nombre & Space(4)
            Mensaje += "Existencia:" & a(x).Cantidad & vbCrLf
        Next

        MsgBox(Mensaje, MsgBoxStyle.Information, "Inventario Galactico")
    End Sub
    ...
    Private Sub rellenaComponentes()
        ...
        txtExistencia.Text = a(cboId.SelectedItem - 1).Precio
    End Sub

    Private Sub cboId_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles cboId.SelectedIndexChanged
        rellenaComponentes()

    End Sub

    Private Sub TextBox3_TextChanged(ByVal sender As Object, ByVal e As EventArgs) Handles txtSubTotal.TextChanged

    End Sub

    Private Sub btnComprar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnComprar.Click
        Dim Mensaje As String = Nothing
        ...
        Else
            ...
            txtGranTotal.Text = granTotal 'A menos que tire error de conversion colocar el ".ToString"
            rellenaComponentes()

            'If (Fila = 0) Then
            '    dgvCaja.Columns.Add(" ", "ID")
            '    dgvCaja.Columns.Add(" ", "Nombre")
            '    dgvCaja.Columns.Add(" ", "Cantidad")
            '    dgvCaja.Columns.Add(" ", "Precio")
            '    dgvCaja.Columns.Add(" ", "Subtotal")
            'End If
    ...
    Private Sub txtCantidadComprar_TextChanged(ByVal sender As Object, ByVal e As EventArgs) Handles txtCantidadComprar.TextChanged
    ...
    Private Sub DataGridView1_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvCaja.CellContentClick, DataGridView1.CellContentClick
